...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	private final static String CAMBIAR_NOMBRE = "CambiarNombre";
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(CAMBIAR_NOMBRE, "Cambiar nombre de categoria", "./data/iconos/libros.png");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (CAMBIAR_NOMBRE.equals(comando))
		{
